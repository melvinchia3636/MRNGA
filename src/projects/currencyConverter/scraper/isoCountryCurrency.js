...
const dataJSON = {
  ...
  AE: {
    countryName: 'United Arab Emirates', currency: 'AED', symbol: 'AED', dateFormat: 'dd/MM/yyyy',
  },
  ...
  AL: {
    countryName: 'Albania', currency: 'ALL', symbol: 'ALL', dateFormat: 'yyyy-MM-dd',
  },
  ...
  AU: {
    countryName: 'Australia', currency: 'AUD', symbol: 'AU$', dateFormat: 'd/MM/yyyy',
  },
  ...
  BA: {
    countryName: 'Bosnia and Herzegovina', currency: 'BAM', symbol: 'KM', dateFormat: 'yyyy-MM-dd',
  },
  BB: { countryName: 'Barbados', currency: 'BBD', symbol: 'BBD' },
  BD: { countryName: 'Bangladesh', currency: 'BDT', symbol: 'Tk' },
  BE: {
    countryName: 'Belgium', currency: 'EUR', symbol: '€', dateFormat: 'd/MM/yyyy',
  },
  BF: { countryName: 'Burkina Faso', currency: 'XOF', symbol: 'CFA' },
  BG: {
    countryName: 'Bulgaria', currency: 'BGN', symbol: 'BGN', dateFormat: 'yyyy-M-d',
  },
  BH: {
    countryName: 'Bahrain', currency: 'BHD', symbol: 'BD', dateFormat: 'dd/MM/yyyy',
  },
  ...
  BY: {
    countryName: 'Belarus', currency: 'BYN', symbol: 'BYN', dateFormat: 'd.M.yyyy',
  },
  BZ: { countryName: 'Belize', currency: 'BZD', symbol: 'BZ$' },
  CA: {
    countryName: 'Canada', currency: 'CAD', symbol: 'CA$', dateFormat: 'dd/MM/yyyy',
  },
  ...
  CH: {
    countryName: 'Switzerland', currency: 'CHF', symbol: 'CHF', dateFormat: 'dd.MM.yyyy',
  },
  CI: { countryName: 'Ivory Coast', currency: 'XOF', symbol: 'CFA' },
  CK: { countryName: 'Cook Islands', currency: 'NZD', symbol: 'NZ$' },
  CL: {
    countryName: 'Chile', currency: 'CLP', symbol: 'CL$', dateFormat: 'dd-MM-yyyy',
  },
  CM: { countryName: 'Cameroon', currency: 'XAF', symbol: 'FCFA' },
  CN: {
    countryName: 'China', currency: 'CNY', symbol: 'CN¥', dateFormat: 'yyyy-M-d',
  },
  CO: {
    countryName: 'Colombia', currency: 'COP', symbol: 'CO$', dateFormat: 'd/MM/yyyy',
  },
  CR: {
    countryName: 'Costa Rica', currency: 'CRC', symbol: '₡', dateFormat: 'dd/MM/yyyy',
  },
  ...
  CY: {
    countryName: 'Cyprus', currency: 'EUR', symbol: '€', dateFormat: 'dd/MM/yyyy',
  },
  CZ: {
    countryName: 'Czech Republic', currency: 'CZK', symbol: 'Kč', dateFormat: 'd.M.yyyy',
  },
  DE: {
    countryName: 'Germany', currency: 'EUR', symbol: '€', dateFormat: 'dd.MM.yyyy',
  },
  DJ: { countryName: 'Djibouti', currency: 'DJF', symbol: 'Fdj' },
  DK: {
    countryName: 'Denmark', currency: 'DKK', symbol: 'Dkr', dateFormat: 'dd-MM-yyyy',
  },
  DM: { countryName: 'Dominica', currency: 'XCD', symbol: 'XCD' },
  DO: {
    countryName: 'Dominican Republic', currency: 'DOP', symbol: 'RD$', dateFormat: 'MM/dd/yyyy',
  },
  DZ: {
  ...
  EG: {
    countryName: 'Egypt', currency: 'EGP', symbol: 'EGP', dateFormat: 'dd/MM/yyyy',
  },
  EH: { countryName: 'Western Sahara', currency: 'MAD', symbol: 'MAD' },
  ER: { countryName: 'Eritrea', currency: 'ERN', symbol: 'Nfk' },
  ES: {
    countryName: 'Spain', currency: 'EUR', symbol: '€', dateFormat: 'dd/MM/yyyy',
  },
  ET: { countryName: 'Ethiopia', currency: 'ETB', symbol: 'Br' },
  FI: {
    countryName: 'Finland', currency: 'EUR', symbol: '€', dateFormat: 'd.M.yyyy',
  },
  ...
  GB: {
    countryName: 'United Kingdom', currency: 'GBP', symbol: '£', dateFormat: 'dd/MM/yyyy',
  },
  ...
  GR: {
    countryName: 'Greece', currency: 'EUR', symbol: '€', dateFormat: 'd/M/yyyy',
  },
  ...
  HK: {
    countryName: 'Hong Kong', currency: 'HKD', symbol: 'HK$', dateFormat: 'yyyy年M月d日',
  },
  HM: { countryName: 'Heard Island and McDonald Islands', currency: 'AUD', symbol: 'AU$' },
  HN: {
    countryName: 'Honduras', currency: 'HNL', symbol: 'HNL', dateFormat: 'MM-dd-yyyy',
  },
  HR: {
    countryName: 'Croatia', currency: 'HRK', symbol: 'kn', dateFormat: 'dd.MM.yyyy.',
  },
  HT: { countryName: 'Haiti', currency: 'HTG', symbol: 'HTG' },
  HU: {
    countryName: 'Hungary', currency: 'HUF', symbol: 'Ft', dateFormat: 'yyyy.MM.dd.',
  },
  ID: {
    countryName: 'Indonesia', currency: 'IDR', symbol: 'Rp', dateFormat: 'dd/MM/yyyy',
  },
  IE: {
    countryName: 'Ireland', currency: 'EUR', symbol: '€', dateFormat: 'dd/MM/yyyy',
  },
  IL: {
    countryName: 'Israel', currency: 'ILS', symbol: '₪', dateFormat: 'dd/MM/yyyy',
  },
  ...
  IS: {
    countryName: 'Iceland', currency: 'ISK', symbol: 'Ikr', dateFormat: 'd.M.yyyy',
  },
  IT: {
    countryName: 'Italy', currency: 'EUR', symbol: '€', dateFormat: 'dd/MM/yyyy',
  },
  JE: { countryName: 'Jersey', currency: 'GBP', symbol: '£' },
  JM: { countryName: 'Jamaica', currency: 'JMD', symbol: 'J$' },
  JO: {
    countryName: 'Jordan', currency: 'JOD', symbol: 'JD', dateFormat: 'dd/MM/yyyy',
  },
  JP: {
    countryName: 'Japan', currency: 'JPY', symbol: '¥', dateFormat: 'H24.MM.dd',
  },
  ...
  KR: {
    countryName: 'South Korea', currency: 'KRW', symbol: '₩', dateFormat: 'yyyy. M. d',
  },
  KW: {
    countryName: 'Kuwait', currency: 'KWD', symbol: 'KD', dateFormat: 'dd/MM/yyyy',
  },
  ...
  LB: {
    countryName: 'Lebanon', currency: 'LBP', symbol: 'LB£', dateFormat: 'dd/MM/yyyy',
  },
  ...
  LT: {
    countryName: 'Lithuania', currency: 'EUR', symbol: '€', dateFormat: 'yyyy.M.d',
  },
  LU: {
    countryName: 'Luxembourg', currency: 'EUR', symbol: '€', dateFormat: 'dd.MM.yyyy',
  },
  LV: {
    countryName: 'Latvia', currency: 'EUR', symbol: '€', dateFormat: 'yyyy.d.M',
  },
  LY: {
    countryName: 'Libya', currency: 'LYD', symbol: 'LD', dateFormat: 'dd/MM/yyyy',
  },
  MA: {
    countryName: 'Morocco', currency: 'MAD', symbol: 'MAD', dateFormat: 'dd/MM/yyyy',
  },
  MC: { countryName: 'Monaco', currency: 'EUR', symbol: '€' },
  MD: { countryName: 'Moldova', currency: 'MDL', symbol: 'MDL' },
  ME: {
    countryName: 'Montenegro', currency: 'EUR', symbol: '€', dateFormat: 'd.M.yyyy.',
  },
  ...
  MT: {
    countryName: 'Malta', currency: 'EUR', symbol: '€', dateFormat: 'dd/MM/yyyy',
  },
  ...
  MX: {
    countryName: 'Mexico', currency: 'MXN', symbol: 'MX$', dateFormat: 'd/MM/yyyy',
  },
  MY: {
    countryName: 'Malaysia', currency: 'MYR', symbol: 'RM', dateFormat: 'dd/MM/yyyy',
  },
  ...
  NI: {
    countryName: 'Nicaragua', currency: 'NIO', symbol: 'C$', dateFormat: 'MM-dd-yyyy',
  },
  NL: {
    countryName: 'Netherlands', currency: 'EUR', symbol: '€', dateFormat: 'd-M-yyyy',
  },
  NO: {
    countryName: 'Norway', currency: 'NOK', symbol: 'Nkr', dateFormat: 'dd.MM.yyyy',
  },
  ...
  NZ: {
    countryName: 'New Zealand', currency: 'NZD', symbol: 'NZ$', dateFormat: 'd/MM/yyyy',
  },
  OM: {
    countryName: 'Oman', currency: 'OMR', symbol: 'OMR', dateFormat: 'dd/MM/yyyy',
  },
  PA: {
    countryName: 'Panama', currency: 'PAB', symbol: 'B/.', dateFormat: 'MM/dd/yyyy',
  },
  PE: {
    countryName: 'Peru', currency: 'PEN', symbol: 'S/.', dateFormat: 'dd/MM/yyyy',
  },
  PF: { countryName: 'French Polynesia', currency: 'XPF', symbol: 'XPF' },
  PG: { countryName: 'Papua New Guinea', currency: 'PGK', symbol: 'PGK' },
  PH: {
    countryName: 'Philippines', currency: 'PHP', symbol: '₱', dateFormat: 'M/d/yyyy',
  },
  PK: { countryName: 'Pakistan', currency: 'PKR', symbol: 'PKRs' },
  PL: {
    countryName: 'Poland', currency: 'PLN', symbol: 'zł', dateFormat: 'dd.MM.yyyy',
  },
  ...
  QA: {
    countryName: 'Qatar', currency: 'QAR', symbol: 'QR', dateFormat: 'dd/MM/yyyy',
  },
  RE: { countryName: 'Reunion', currency: 'EUR', symbol: '€' },
  RO: {
    countryName: 'Romania', currency: 'RON', symbol: 'RON', dateFormat: 'dd.MM.yyyy',
  },
  RS: {
    countryName: 'Serbia', currency: 'RSD', symbol: 'din.', dateFormat: 'd.M.yyyy.',
  },
  RU: {
    countryName: 'Russia', currency: 'RUB', symbol: 'RUB', dateFormat: 'dd.MM.yyyy',
  },
  RW: { countryName: 'Rwanda', currency: 'RWF', symbol: 'RWF' },
  SA: {
    countryName: 'Saudi Arabia', currency: 'SAR', symbol: 'SR', dateFormat: 'dd/MM/yyyy',
  },
  SB: { countryName: 'Solomon Islands', currency: 'SBD', symbol: 'SBD' },
  SC: { countryName: 'Seychelles', currency: 'SCR', symbol: 'SCR' },
  SD: {
    countryName: 'Sudan', currency: 'SDG', symbol: 'SDG', dateFormat: 'dd/MM/yyyy',
  },
  SE: {
    countryName: 'Sweden', currency: 'SEK', symbol: 'Skr', dateFormat: 'yyyy-MM-dd',
  },
  SG: {
    countryName: 'Singapore', currency: 'SGD', symbol: 'S$', dateFormat: 'M/d/yyyy',
  },
  SH: { countryName: 'Saint Helena', currency: 'SHP', symbol: 'SHP' },
  SI: {
    countryName: 'Slovenia', currency: 'EUR', symbol: '€', dateFormat: 'd.M.yyyy',
  },
  SJ: { countryName: 'Svalbard and Jan Mayen', currency: 'NOK', symbol: 'Nkr' },
  SK: {
    countryName: 'Slovakia', currency: 'EUR', symbol: '€', dateFormat: 'd.M.yyyy',
  },
  ...
  TH: {
    countryName: 'Thailand', currency: 'THB', symbol: '฿', dateFormat: '๓/๖/๒๕๕๕',
  },
  ...
  TR: {
    countryName: 'Turkey', currency: 'TRY', symbol: 'TL', dateFormat: 'dd.MM.yyyy',
  },
  TT: { countryName: 'Trinidad and Tobago', currency: 'TTD', symbol: 'TT$' },
  TV: { countryName: 'Tuvalu', currency: 'AUD', symbol: 'AU$' },
  TW: {
    countryName: 'Taiwan', currency: 'TWD', symbol: 'NT$', dateFormat: 'yyyy/M/d',
  },
  ...
  UY: {
    countryName: 'Uruguay', currency: 'UYU', symbol: '$U', dateFormat: 'dd/MM/yyyy',
  },
  ...
  YE: {
    countryName: 'Yemen', currency: 'YER', symbol: 'YR', dateFormat: 'dd/MM/yyyy',
  },
  YT: { countryName: 'Mayotte', currency: 'EUR', symbol: '€' },
  ZA: {
    countryName: 'South Africa', currency: 'ZAR', symbol: 'R', dateFormat: 'yyyy/MM/dd',
  },
